...
// Show the bitmap in Marlin/_Statusscreen.h onste the status screen.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 79.9, 136.6 }
...
#define Z_SERVO_ANGLES { 155, 80 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 55, -0.75 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 90  // X point for Z homing
